  ...
  return (
    <div className="col-span-12 rounded-[10px] bg-white px-5 pb-5 pt-7.5 shadow-1 dark:bg-gray-dark dark:shadow-card sm:px-7.5 xl:col-span-7">
      ...
      <div className="mb-3 flex flex-wrap gap-6">
        <div>
          <p className="mb-1.5 text-body-sm font-medium">Invested Value</p>
          <div className="flex items-center gap-2.5">
            <p className="font-medium text-dark dark:text-white">$1,279.95</p>
            <p className="flex items-center gap-1 font-medium text-green">
              1,22%
              <svg
        ...
        <div>
          <p className="mb-1.5 text-body-sm font-medium">Total Returns</p>
          <div className="flex items-center gap-2.5">
            <p className="font-medium text-dark dark:text-white">$22,543.87</p>
            <p className="flex items-center gap-1 font-medium text-green">
              10.14%
              <svg
                className="fill-current"
