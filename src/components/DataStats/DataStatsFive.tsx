            ...
            >
              ...
              <div className="mt-5.5 flex flex-col gap-1.5">
                <div className="flex items-center justify-between gap-1">
                  <p className="text-body-sm font-medium">Total Share</p>
                ...
                <div className="flex items-center justify-between gap-1">
                  <p className="text-body-sm font-medium">Total Return</p>
