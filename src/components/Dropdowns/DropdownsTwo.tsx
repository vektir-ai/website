      ...
      <div className="p-4 sm:p-6 xl:p-10">
        <div className="relative mb-50 inline-block">
          ...
          <ClickOutside onClick={() => setDropdownOpen(false)}>
            {dropdownOpen && (
              <div
                className={`shadow-card-4 absolute left-0 top-full z-40 mt-2 w-full rounded-[7px] bg-primary py-3`}
              >
                <ul className="flex flex-col">
                  <li>
                    <Link
                      href="#"
                      className="flex px-5 py-[7px] font-medium text-[#ACBBED] hover:text-white"
                    >
                      Dashboard
                    </Link>
                  </li>
