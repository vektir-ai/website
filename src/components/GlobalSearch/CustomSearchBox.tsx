...
function CustomSearchBox({ refine }: any) {
  return (
    <form
      action=""
      role="search"
      className="sticky top-0 z-[99999] rounded-t-xl border-b border-stroke dark:border-dark-3 dark:bg-dark"
    >
      <div className="relative">
        <input
          ...
          className="h-[74px] w-full rounded-lg pl-[60px] pr-5 text-dark outline-none dark:bg-dark dark:text-gray-5"
        />
