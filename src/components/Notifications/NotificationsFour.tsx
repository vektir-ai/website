      ...
      <div className="p-4 sm:p-6 xl:p-10">
        <div className="flex flex-col gap-5">
          {notificationList.map((item, index) => (
            <div
              key={index}
              className={`shadow-card-9 rounded-[10px] border-l-[5px] bg-white px-4 py-6 dark:bg-dark-2 sm:px-5 xl:px-7.5 ${
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-5">
                ...
                <span className="inline-flex rounded-md bg-gray px-2.5 py-1.5 text-body-sm font-medium dark:bg-dark-3">
                  {item.date}
                </span>
              </div>
            </div>
