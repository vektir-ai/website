      ...
      <div className="p-4 sm:p-6 xl:p-7.5">
        <nav>
          <ul className="flex flex-wrap items-center">
            <li>
              <Link
                className="flex h-9 w-9 items-center justify-center rounded-l-md border border-stroke hover:border-primary hover:bg-gray-2 hover:text-primary dark:border-dark-3 dark:hover:border-primary dark:hover:bg-dark-2"
                href="#"
              >
                <svg
            ...
            <li>
              <Link
                className="flex h-9 w-9 items-center justify-center rounded-r-md border border-stroke border-l-transparent hover:border-primary hover:bg-gray-2 hover:text-primary dark:border-dark-3 dark:hover:border-primary dark:hover:bg-dark-2"
                href="#"
              >
                <svg
                  className="fill-current stroke-current"
