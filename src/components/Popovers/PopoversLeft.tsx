      ...
      <div className="mt-10 text-center sm:mb-60">
        <div className="relative inline-block">
          ...
          <ClickOutside onClick={() => setPopoversOpen(false)}>
            {popoversOpen && (
              <div
                className={`absolute right-full top-0 z-20 mr-3 w-max max-w-[311px] rounded bg-white drop-shadow-5 dark:bg-dark-2`}
              >
                <span className="absolute -right-1.5 top-4 -z-10 h-4 w-4 rotate-45 rounded-sm bg-white dark:bg-dark-2"></span>
