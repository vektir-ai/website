      ...
      <div className="mt-10 text-center sm:mb-60">
        <div className="relative inline-block">
          ...
          <ClickOutside onClick={() => setPopoversOpen(false)}>
            {popoversOpen && (
              <div
                className={`absolute bottom-full left-1/2 z-20 mb-3 w-max max-w-[311px] -translate-x-1/2 rounded bg-white drop-shadow-5 dark:bg-dark-2 `}
              >
                <span className="absolute -bottom-1.5 left-1/2 -z-10 h-4 w-4 -translate-x-1/2 rotate-45 rounded-sm bg-white dark:bg-dark-2"></span>
