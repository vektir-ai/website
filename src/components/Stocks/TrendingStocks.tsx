        ...
        {stocksItems.map((item, key) => (
          ...
          >
            <div className="mb-5.5 flex items-center justify-between">
              <div className="flex items-center gap-4.5">
                ...
                <div>
                  ...
                  <p className="text-body-xs font-medium">${item.gross}</p>
                </div>
              </div>

              <div className="text-right">
                <p
                  className={`mb-0.5 flex items-center justify-end gap-1 text-body-xs font-medium ${
            ...
            <div className="flex items-center gap-4">
              <button className="flex w-full items-center justify-center rounded-[5px] bg-[#F3F5F8] px-7.5 py-2 text-body-sm font-medium text-dark hover:bg-primary/[0.15] hover:text-primary dark:bg-dark-2 dark:text-white dark:hover:bg-primary/[0.15] dark:hover:text-primary">
                Short
              </button>
              <button className="flex w-full items-center justify-center rounded-[5px] bg-[#F3F5F8] px-7.5 py-2 text-body-sm font-medium text-dark hover:bg-primary/[0.15] hover:text-primary dark:bg-dark-2 dark:text-white dark:hover:bg-primary/[0.15] dark:hover:text-primary">
                Buy
