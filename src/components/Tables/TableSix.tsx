...
const TableSix: React.FC = () => {
  return (
    <div className="shadow-card-6 max-w-full overflow-x-auto">
      <div className="min-w-[1170px]">
        ...
        {/* table body start */}
        <div className="rounded-b-[10px] bg-white dark:bg-gray-dark">
          {data.map((item, index) => (
            <div
              key={index}
            ...
            >
              <div className="col-span-3">
                <p className="text-[#637381] dark:text-dark-6">{item.name}</p>
              </div>

              <div className="col-span-3">
                <p className="text-[#637381] dark:text-dark-6">
                  {item.position}
                </p>
              </div>

              <div className="col-span-3">
                <p className="text-[#637381] dark:text-dark-6">{item.email}</p>
              </div>

              <div className="col-span-2">
                <p className="text-[#637381] dark:text-dark-6">{item.role}</p>
              </div>
