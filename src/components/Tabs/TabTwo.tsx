  ...
  return (
    <div className="rounded-[10px] bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark">
      <div className="border-b border-stroke px-4 py-4 dark:border-dark-3 sm:px-6 xl:px-7.5">
        <h3 className="font-medium text-dark dark:text-white">Tab Style 2</h3>
      </div>

      <div className="p-4 sm:p-6 xl:p-7.5">
        <div className="mb-7.5 flex flex-wrap gap-3.5 border-b border-stroke p-3 dark:border-dark-3">
          {tabs.map((item, index) => (
            <Link
              key={index}
              href="#"
